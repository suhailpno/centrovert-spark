      ...
      <div className="container mx-auto container-padding">
        ...
        >
          {services.map((service, index) => (
            ...
            >
              <div className="mb-6 p-3 rounded-2xl bg-primary/5 text-primary group-hover:bg-primary group-hover:text-primary-foreground transition-colors duration-500 w-fit">
